...
/**
 * List class for ComplexComposite.
 */
public final class ComplexCompositeList extends java.util.ArrayList<ComplexComposite> implements BaseCompositeList<ComplexComposite>
{
  /**
   * Short form for type.
   */
   ...
   */
  public static final Long SHORT_FORM = Long.valueOf(27866027022876669L);
  private static final long serialVersionUID = 27866027022876669L;
  /**
   * Default constructor for ComplexCompositeList.
   */
  public ComplexCompositeList()
  {
  }
   ...
   */
  public ComplexCompositeList(int initialCapacity)
  {
  ...
  {
    return new ComplexCompositeList();
  }
  ...
  public void encode(org.ccsds.moims.mo.mal.MALEncoder encoder) throws org.ccsds.moims.mo.mal.MALException
  {
    ...
    {
      listEncoder.encodeNullableElement((ComplexComposite) get(i));
    }
    listEncoder.close();
  }
  ...
  public org.ccsds.moims.mo.mal.structures.Element decode(org.ccsds.moims.mo.mal.MALDecoder decoder) throws org.ccsds.moims.mo.mal.MALException
  {
    ...
    {
      add((ComplexComposite) listDecoder.decodeNullableElement(new ComplexComposite()));
    }
    return this;
  }
