...
public class SecureServerSetup extends BasicSecureServerSetup {
    public SecureServerSetup() throws Exception {
        super();
        serverProperties.put(Constants.KEY_STORE_FILE_KEY, "./server.pfx");
        serverProperties.put(Constants.TRUST_STORE_FILE_KEY, "./server-trust.pfx");
        serverProperties.put(Constants.KEY_STORE_TYPE, "PKCS12");
