...
package nasa.mo.mal.transport.https.pkcs12tojks;

import nasa.mo.mal.transport.http.HttpTransportRequestExceptionTest;
 ...
 *         Created on 7/24/17.
 */
public class HttpXmlTransportRequestExceptionTest extends HttpTransportRequestExceptionTest {
    @BeforeClass
